...
#define SCLEX_LBS 100
#define SCLEX_LBS2 101
...
#define SCE_LBS_DEFAULT			0		//默认样式

#define SCE_LBS_UNIT_NAME		1		//单元类型
#define SCE_LBS_OPERATOR		2		//操作符 + - * / && || != > < =
#define SCE_LBS_PREFIX			3		//前缀

#define SCE_LBS_STRING			4		//字串

#define SCE_LBS_PRIVATE_METHOD	5		//私有函数
#define SCE_LBS_PUBLIC_METHOD	6		//公共函数

#define SCE_LBS_VARIABLE		7		//变量

#define SCE_LBS_KEYWORDS		8		//关键字

#define SCE_LBS_COMMENTS		9		//注释
#define SCE_LBS_COMMENTS1		10		//注释
#define SCE_LBS_COMMENTS2		11		//注释
#define SCE_LBS_SEPARATOR		12		//分隔符
#define SCE_LBS_LINKCMD			13		//链接命令
#define SCE_LBS_CUSTOM_METHOD	14		//自定义函数

#define SCE_LBS_UNKNOWN			10000	//未知
...
#define SCE_LBS2_DEFAULT		0		//默认样式
#define SCE_LBS2_OPERATOR		1		//操作符 + - * / && || != > < =
#define SCE_LBS2_SEPARATOR		2		//分隔符
#define SCE_LBS2_NUMBER			3		//数字
#define SCE_LBS2_STRING			4		//字串
#define SCE_LBS2_CONSTANT		5		//常量
#define SCE_LBS2_KEYWORDS		6		//关键字
#define SCE_LBS2_SYSFUNCTION	7		//系统层函数
#define SCE_LBS2_APPFUNCTION	8		//应用层函数
#define SCE_LBS2_LINECOMMENTS	9		//注释
#define SCE_LBS2_COMMENTS		10		//注释

#define SCE_LBS2_UNKNOWN		10000	//未知
